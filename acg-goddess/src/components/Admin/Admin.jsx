...
// 引入antd
import { Tabs, Button, Carousel, Card, Avatar, Modal } from 'antd';
// 引入Link
...
import { delUser } from '../../redux/action-creators'
...
const { TabPane } = Tabs;
const { confirm } = Modal
@connect(state => ({ token: state.users.token, isAdmin: state.users.user.isAdmin }), { delUser })
class Admin extends Component {
  ...
  render () {
    const {token,isAdmin,history} = this.props
    return (
      <div className="admin">
            ...
            <ul className="admin-list">
              ...
              <div className="adminListRight" style={{ background: 'rgba(249, 244,241,0.6)', padding: '30px' }}>
                <Card title="用户信息" bordered={false} style={{ width: 300 }}>
                  ...
                  <p>admin</p>
                  {
                    token?<Button type="link" size="large" onClick={this.showConfirm}>注销</Button>:<div />
                  }
                  {
                    isAdmin ? <Button type="link"  size="large" onClick={() => { history.replace('/home') }}> 管理</Button> : <div />
                  }
